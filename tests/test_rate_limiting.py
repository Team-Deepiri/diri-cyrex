...
class TestWorkflowRateLimitAPI:
    ...
    def test_workflow_rate_limit_429_response(self):
        ...
        # Note: This test requires mocking to trigger rate limit
        # In a real scenario, you'd set up a Redis instance with rate limits
        # or mock the execution to raise ToolRateLimitExceeded
        
        # Placeholder for integration test
        # A full integration test would require:
        # 1. Running Redis
        # 2. Setting up rate limits
        # 3. Making multiple requests to exceed the limit
        # 4. Verifying 429 response with Retry-After
    ...
    def test_workflow_execution_includes_user_id_in_state(self):
        ...
        # This test verifies that user_id extraction works
        # Full test would require authentication middleware and workflow execution
